...
This is a simple HTML, CSS, and JavaScript project in which the main objective is to build out a "Newsletter sign-up
form with success message" web page.

### Screenshot

![Screenshot](./newsletter-sign-up-form.png)
...
To complete the layout, I then proceeded to write the media queries for the desktop design. After the design was
completed, I proceeded to add some interactivity to the page using JavaScript.
